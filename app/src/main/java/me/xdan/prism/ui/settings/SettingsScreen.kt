...
fun SettingsScreen(modifier: Modifier = Modifier) {
    ...
    val defaultSandboxed by context.dataStore.data
        .collectAsStateWithLifecycle(initialValue = androidx.datastore.preferences.core.emptyPreferences())
        .let { preferences -> mutableStateOf(preferences[DefaultSandboxKey] ?: true) }
            ...
            Card(colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surfaceContainerHighest)) {
                Column(modifier = Modifier.padding(20.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        androidx.compose.material3.Icon(Icons.Default.FavoriteBorder, contentDescription = null)
                    ...
                    TextButton(
                        onClick = { openUrl(context, "https://github.com/sponsors/XDanfr") },
